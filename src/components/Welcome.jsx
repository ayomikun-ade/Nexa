const Welcome = () => {
  return (
    <div className="text-white text-center animate-textIn flex flex-col justify-center items-center mb-5 w-full h-full">
      ...
      <span className="w-40 h-40" aria-label="a waving hand">
        <svg
          viewBox="0 0 64 64"
